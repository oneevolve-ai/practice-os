...
import { Users, Building2, CalendarOff, Clock, Calendar, FileText, RefreshCw, DollarSign, ClipboardList, TrendingUp, LogOut } from "lucide-react";
...
const navGroups = [
  {
    ...
    items: [
      ...
      { name: "Exit", href: "/people/exit", icon: LogOut },
    ],
  },
  {
    label: "Leave",
